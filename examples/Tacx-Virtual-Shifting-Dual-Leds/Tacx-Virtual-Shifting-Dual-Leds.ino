/***************************************************************************************************
                    ...
                    This is programming code for ESP32 Espressif boards
                         ...
                         Tested with - Seeed Studio XIAO ESP32-S3
...
// Uses 2 additional leds to indicate status of connections
#include "dualLedsHelper.h"
...
void setup() {
...
#endif
    LOG("ESP32 NimBLE Tacx Legacy Virtual Shifting - Dual Leds");
  ...
  // Create LED FreeRTOS task pinned to core 0 (WiFi/BLE stack usually lives on core 0 too)
