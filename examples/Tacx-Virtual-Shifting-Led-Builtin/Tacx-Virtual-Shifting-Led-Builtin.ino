...
// Use the builtin Led of your board to indicate status of the ESP32-Trainer connection
#include "ledBuiltinHelper.h"
...
#endif
    LOG("ESP32 NimBLE Tacx Legacy Virtual Shifting Led Builtin");
